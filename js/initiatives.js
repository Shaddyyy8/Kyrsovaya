...
const INITIATIVES_DATA = [
    {
        ...
        checklist: [
            "День 1: Используйте многоразовую бутылку",
            "День 2: Возьмите свою сумку в магазин",
            "День 3: Откажитесь от пластиковых пакетов",
            "День 4: Купите продукты в стеклянной таре",
            "День 5: Откажитесь от пластиковых соломинок",
            "День 6: Используйте многоразовые контейнеры",
            "День 7: Сдайте пластик на переработку"
        ],
        rewards: {
            ecoPoints: 150,
    ...
    },
    {
        ...
        checklist: [
            "День 1: Проведите ревизию кухонных запасов — отметьте, что можно использовать",
            "День 2: Составьте список покупок и план питания на неделю",
            "День 3: Перейдите на многоразовые мешочки и сумки для покупок",
            "День 4: Откажитесь от одноразовой посуды и салфеток",
            "День 5: Начните компостировать органические отходы",
            "День 6: Покупайте продукты без упаковки (на развес) или в стеклянной таре",
            "День 7: Приготовьте обед из остатков — минимизируйте пищевые отходы"
        ],
        rewards: {
            ecoPoints: 300,
