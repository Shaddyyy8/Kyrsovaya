...
- **`eco-platform/html/`** – основные страницы сайта:
  - `dashboard.html` – дашборд пользователя (эко‑баллы, привычки, инициативы, рекомендации товаров и статей).
...
3. В браузере перейдите, например, на:
   - `http://localhost:8000/html/dashboard.html`
   - `http://localhost:8000/html/products.html`
   - `http://localhost:8000/html/articles.html` и т.д.
